...
class Kaupiamsis_Inasas(models.Model):
    ...
    def send_payment_email(self):
        ...
        flat = self.flat_nr  # Gauti susijusį buto objektą
        if flat and flat.owner and flat.owner.email:
            recipient_list = [flat.owner.email]  # Naudoti tiesiog flat.owner.email
